...
class ViewToggle {
  private currentView: ViewType = 'latest';
  private recentBtn: HTMLElement | null = null;
  ...
  private setupEventListeners(): void {
    if (!this.recentBtn || !this.topBtn) return;
   ...
   */
  private setActive(view: ViewType): void {
    if (view === 'top') {
   ...
   */
  private activateRecentView(): void {
    if (!this.recentBtn || !this.topBtn) return;
   ...
   */
  private updateURL(view: ViewType): void {

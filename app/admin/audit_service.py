...
class AuditService:
    ...
    def create_action(
        ...
        try:
            ...
            action.update_hash()  # Update the hash with proper prev_hash
            db.session.commit()
            return action
    ...
    def verify_chain_integrity(
        ...
        """
        Verify the integrity of the hash chain between two points.
    ...
    def _calculate_action_hash(cls, action: AdminAction) -> str:
        """
        Calculate the expected hash for an action.
